...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF18847E);
  late Color tertiary = const Color(0xFFF9A885);
  late Color alternate = const Color(0xFF2CB9B4);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFFFF6F6);
  late Color secondaryBackground = const Color(0xFFEAF2F2);
  late Color accent1 = const Color(0xFF0800E7);
  late Color accent2 = const Color(0x4D48B3A6);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF8CB095);
  late Color warning = const Color(0xFFFFD55F);
  late Color error = const Color(0xFFFF7676);
  late Color info = const Color(0xFFB9B0B0);
}
